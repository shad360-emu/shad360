...
public class XConfigManager
{
    ...
    public static bool XConfigExists(EmulatorVersion version)
    {
    ...
    public static XConfigFile? LoadXConfig(EmulatorVersion version)
    {
    ...
    public static void SaveXConfig(XConfigFile xconfig, EmulatorVersion version)
    {
