...
using Shad360.Core.Models.Files.Shortcut;
using Shad360.Core.Models.Files.SteamShortcuts;
using Shad360.Core.Models.Files.Vdf;
...
public class ShortcutManager
{
    ...
    public static void CreateShortcut(Game game, string? directory = null)
    {
        ...
        // Set the target path (Shad360.exe)
        string targetPath = Environment.ProcessPath ?? AppPathResolver.GetFullPath("Shad360.exe");
