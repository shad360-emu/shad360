...
using Shad360.Core.Models.Files.Stfs;
...
public class ProfileManager
{
    ...
    public static AccountInfo CreateAccount(EmulatorVersion version, string gamertag, bool defaultXuid = false)
    {
    ...
    public static List<AccountInfo> LoadProfiles(EmulatorVersion version)
    {
    ...
    public static int SaveProfiles(List<AccountInfo> profiles, EmulatorVersion version)
    {
    ...
    public static bool DeleteAccount(EmulatorVersion version, AccountInfo profile)
    {
    ...
    public static async Task<bool> ExportProfile(EmulatorVersion version, AccountInfo? profile, bool exportSaves = false, string? outputPath = null)
    {
        if (profile == null)
        {
    ...
    public static AccountInfo? CheckForExistingProfile(EmulatorVersion version, string xuid)
    {
    ...
    public static async Task<AccountInfo?> ImportProfile(EmulatorVersion version, string zipPath, List<AccountInfo> profiles)
    {
    ...
    /// <returns>The imported profile if successful, null otherwise.</returns>
    public static async Task<AccountInfo?> ImportProfileWithReplacement(EmulatorVersion version, string zipPath, List<AccountInfo> profiles, Func<AccountInfo, Task<bool>> onProfileExists)
    {
