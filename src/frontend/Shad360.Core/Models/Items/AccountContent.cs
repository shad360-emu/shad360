...
namespace Shad360.Core.Models.Items;
...
public class AccountContent
{
    ...
    /// </summary>
    public EmulatorVersion EmulatorVersion { get; internal set; }

    /// <summary>
    /// Gets the path to the Xenia content folder.
    /// </summary>
    public string XeniaContentFolder => AppPathResolver.GetFullPath(EmulatorPaths.ContentFolderLocation);
    ...
    /// <param name="EmulatorVersion">Xenia Version of the account.</param>
    /// <param name="titleId">Game TitleId</param>
    public AccountContent(AccountInfo accountInfo, EmulatorVersion EmulatorVersion, string titleId)
    {
