...
public class StfsFile : IDisposable
{
    ...
    public static StfsFile LoadHeaderOnly(string filePath)
    {
        ...
        // Read only the first 0xA000 bytes â€” should be enough for the full metadata header.
    ...
    /// Reads only the first 4KB of the file â€” significantly more memory-efficient than loading the full package.
